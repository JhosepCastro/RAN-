...
<body>
    ...
    <header>
        ...
        <nav class="head_titu">
            ...
            <a href="php/tienda/tienda1/index.php">PLANTAS</a>
                ...
                <div class="galeria-port">
                    <div class="imagen-port" id="po1">
                        ...
                        <div class="hover-galeria" id="im1">
                            <img class='logo3'src="img/iconos/cactus (1).png" alt="">
                            <p>suculentas</p>
                        </div>
                    </div>
                   ...
                   <div class="imagen-port" id="po3">
                        ...
                        <div class="hover-galeria" id="im3">
                           <a href="inicio_sesion/inicio.html"> <img  src="img/iconos/carne.png" alt=""></a>
                            <p>CARNIVORAS</p>
                        </div>
                    </div></a>
                    <div class="imagen-port" id="po4">
                        ...
                        <div class="hover-galeria" id="im4">
                            <img src="img/iconos/lirio.png" alt="">
                            <p>jardin</p>
                        </div>
                    </div>
                    ...
                    <div class="imagen-port" id="po6">
                        ...
                        <a href="php/seccion/orquidea.php"> <img src="img/iconos/orquid.png" alt=""></a>
                            <p>orquidea</p>
                        </div>
                    </div>
